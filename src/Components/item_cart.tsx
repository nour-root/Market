...
export default function Item_cart({
  ...
  return (
    <div className="bg-white rounded-[10px] shadow flex gap-2 h-auto max-[424px]:h-auto  max-[424px]:flex-col max-[424px]:items-center max-[424px]:relative">
      <img src={order.image} className="w-1/6 max-[424px]:w-1/2 p-4" alt="" />
