        ...
        <ul className="*:border-b *:border-r *:bg-accent">
          {list.map((item, i) => (
            <li
              ...
              className={`relative px-2 py-3 text-center flex flex-col items-center space-y-1 max-w-[87.2px] cursor-pointer before:absolute before:h-full before:w-[7px] before:left-0 before:top-0`}
            >
              {item.icon}
